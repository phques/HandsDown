...
//
#define HD_adaptive_code "handsdown/au2-adaptive.c"
//
// au2: pq 2024-06-08 swap WK, GF
...
//      ╭─────────────────────╮                 ╭─────────────────────╮
// esc  │  J   F   M   P   V  │ L_CFG     L_NUM │  #$  .:  /*  "[  '] │ LANG2/henk
// tab  │  R   S   N   D   B  | (             ) |  ,;   A   E   I   H │ LANG1/mhen
//  Z   │  X   G   L   C   K  │ [ copy   pste ] │  -+   U   O   Y   W │ Q
//      ╰───────────╮ bsp  T  │ &             | │ spc  ret ╭──────────╯
...
//##pq this is overwritten by "ch"
//#define HD_L1_keys HD_LM3, HD_LM1 // ex. TYPE "z" (pq 2024-06-08, overwritten by "ch")
#define HD_L1_keys HD_LT4, HD_LT1 // ex. TYPE "z
#define HD_L1 HD_Z
...
#define HD_Wh_keys HD_RB4, HD_RB3 // TYPE "wh" pq 2024-06-08, swap WK
#define HD_Sh_keys HD_LM3, HD_LM2 // TYPE "sh"
#define HD_Ph_keys HD_LT1, HD_LT2 // TYPE "ph"
//#define HD_Gh_keys HD_LT3, HD_LT2 // TYPE "gh"
#define HD_Gh_keys HD_LB3, HD_LB1 // TYPE "gh" (pq 204-06-08 swap GF. nb: cannot use B3-B2, it's for Copy)
...
//(pq 204-06-08 swap GF)
//#define HD_there_keys HD_T, HD_F  // TYPE "there" #7 + 's
#define HD_there_keys HD_T, HD_G  // TYPE "there" #7 + 's
...
#define HD_wed_keys   HD_X, HD_F  // TYPE "we'd" + 've
