...
//
#define HD_A LSFT_T(KC_A)
#define HD_B KC_B
#define HD_C LCTL_T(KC_C)
#define HD_D KC_D
#define HD_E LGUI_T(KC_E)
...
#define HD_RT5 KC_Z //pq KC_LNG2, *not* mirrored
#define HD_RT4 HD_V
#define HD_RT3 HD_W
#define HD_RT2 HD_G
#define HD_RT1 HD_M
...
#define HD_LT5 TG(L_NAV) //pq KC_LNG1, *not* mirrored

#define HD_RM5 TT(L_FUN)  //pq KC_Z, *not* mirrored
#define HD_RM4 HD_S
#define HD_RM3 HD_N
#define HD_RM2 HD_T
#define HD_RM1 HD_H
...
#define HD_LM3 HD_I
#define HD_LM4 HD_C
#define HD_LM5 KC_ESC //pq *not* mirrored

#define HD_RB5 HD_Q // (linger adds lowercase u), pq *not* mirrored
#define HD_RB4 HD_F
#define HD_RB3 HD_P
#define HD_RB2 HD_D
#define HD_RB1 HD_L
#define HD_RB0 HD_X
#define HD_RBA SK_DKT8 // Dictate (speech to text)
#define HD_RBB SK_FIND // find
#define HD_LBB SK_FAGN // find again
#define HD_LBA SK_AIVC // AI voice control (Siri/Cortana)
#define HD_LB0 HD_MINS
#define HD_LB1 HD_U
#define HD_LB2 HD_O
#define HD_LB3 HD_Y
#define HD_LB4 HD_B
#define HD_LB5 KC_TAB //pq *not* mirrored
...
#define HD_Ch_keys HD_LM3, HD_LM4 // TYPE "ch" // same as "I" HD_Icap_keys
#else
...
#else
#define HD_Ph_keys HD_RB3, HD_RB1 // TYPE "ph"  // keep as in Vibranium
#endif
